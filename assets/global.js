...
class SliderComponent extends HTMLElement {
  ...
  resetPages() {
    this.sliderItems = this.querySelectorAll('[id^="Slide-"]');
    this.initPages();
    this.setSlidePosition(1); // Manually set initial position to 1
  }
  ...
  update() {
    ...
    // Custom: Configure total page count dynamically based on all variant selections
    document
...
class VariantSelects extends HTMLElement {
  ...
  // Custom: Getting Current Variant for customization of selected variant images.
